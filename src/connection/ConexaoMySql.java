...
public class ConexaoMySql {
    ...
    private String nomeDoBanco = "teste";
    private String usuario = "root";
    private String senha = "99102904";
    ...
    public void doo() {
        this.conectar();
        this.executarSQL("CREATE TABLE qwe (id INT NOT NULL, nome VARCHAR(10))");
    }
    ...
    public Connection conectar() {
        try {
            ...
            String url = "jdbc:mariadb://" + servidor + "/" + nomeDoBanco + "?useTimezone=true&serverTimezone=UTC";
